...
public interface AccountsApi {
	...
	@Operation(summary = "Get Products", operationId = "getAccountsAccountIdProduct", description = "", tags = { "Products", })

	@RequestMapping(
			value = "/accounts/{AccountId}/product",
			produces = { "application/json; charset=utf-8", "application/json", "application/jose+jwe" },
			method = RequestMethod.GET)
	default ResponseEntity<OBReadProduct2> getAccountsAccountIdProduct(@Parameter(name = "AccountId", required = true)
