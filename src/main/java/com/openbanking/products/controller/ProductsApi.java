package com.openbanking.products.controller;

import com.openbanking.products.model.OBReadProduct2;
...
public interface ProductsApi {
	...
	@Operation(summary = "Get Products", operationId = "getProducts", description = "", tags = { "Products", })

	@RequestMapping(
			value = "/products",
			produces = { "application/json; charset=utf-8", "application/json", "application/jose+jwe" },
			method = RequestMethod.GET)
	default ResponseEntity<OBReadProduct2> getProducts(@Parameter(name = "An Authorisation Token as per https://tools.ietf.org/html/rfc6750", required = true)
