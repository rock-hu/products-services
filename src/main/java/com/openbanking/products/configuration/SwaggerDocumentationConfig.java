package com.openbanking.products.configuration;
...
public class SwaggerDocumentationConfig {
	...
	Artifact artifact) {
		return GroupedOpenApi.builder().group("products-services")
				...
				.packagesToScan("com.openbanking.products.controller").build();
	}
